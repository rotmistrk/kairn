...
pub struct AppState {
    ...
    pub(crate) build_errors: Vec<crate::build::ErrorLocation>,
    ...
    pub(crate) doc_versions: std::collections::HashMap<String, i64>,
    pub(crate) lsp_opened_files: std::collections::HashSet<String>,
    /// MCP snapshot (updated periodically for MCP server reads).
    pub(crate) mcp_snapshot: Option<Arc<Mutex<crate::mcp::snapshot::McpSnapshot>>>,
    /// MCP command queue for write operations from MCP tools.
    pub(crate) mcp_commands: Option<crate::mcp::commands::McpCommandQueue>,
    pub(crate) mcp_tick: u16,
    pub(crate) waker: Option<txv_core::run::Waker>,
    pub(crate) theme_state: Option<std::cell::RefCell<crate::theme_state::ThemeState>>,
    pub(crate) grep_pending: Option<(String, std::sync::Arc<crate::grep::GrepState>, std::path::PathBuf)>,
    pub(crate) build_pending: Option<(
        String,
        std::sync::Arc<crate::task_output::TaskOutput>,
        std::path::PathBuf,
    )>,
    pub(crate) pending_tab: Option<crate::eviction::PendingTab>,
    /// Active confirmation context — routes CM_CONFIRM_RESPONSE to the right handler.
    pub(crate) confirm_context: Option<crate::commands::ConfirmContext>,
    ...
    pub(crate) lsp_languages: crate::completer::LspLanguageList,
    /// Plugin hot-reload manager.
    pub(crate) plugins: crate::scripting::plugins::PluginManager,
    ...
    pub(crate) lsp_status: crate::lsp::progress::LspStatusTracker,
    ...
    pub(crate) pty_last_output: std::collections::HashMap<usize, std::time::Instant>,
}

impl AppState {
    pub fn broker_open(&mut self, path: &str, slot: crate::desktop::SlotId, idx: usize) -> crate::broker::OpenResult {
    ...
    pub fn set_mcp_snapshot(&mut self, snap: Arc<Mutex<crate::mcp::snapshot::McpSnapshot>>) {
        self.mcp_snapshot = Some(snap);
    }
    pub fn mcp_snapshot(&self) -> &Option<Arc<Mutex<crate::mcp::snapshot::McpSnapshot>>> {
        &self.mcp_snapshot
    }
    pub fn mcp_commands(&self) -> &Option<crate::mcp::commands::McpCommandQueue> {
        &self.mcp_commands
    }
    pub fn set_mcp_commands(&mut self, q: crate::mcp::commands::McpCommandQueue) {
    ...
    pub fn set_theme_state(&mut self, ts: crate::theme_state::ThemeState) {
        self.theme_state = Some(std::cell::RefCell::new(ts));
    }
    ...
    pub fn pending_tab(&self) -> &Option<crate::eviction::PendingTab> {
        &self.pending_tab
    }
    pub fn set_pending_tab(&mut self, tab: Option<crate::eviction::PendingTab>) {
