...
impl EditorView {
    pub(super) fn draw_sbs_diff(&mut self) {
        ...
        let gap_style = txv_core::palette::palette().style(txv_core::palette::StyleId::Dim);
        let divider_style = txv_core::palette::palette().style(txv_core::palette::StyleId::Dim);
